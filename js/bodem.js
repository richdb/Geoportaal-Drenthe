...
function flamingo_onInit() {
	...
	if (vis.length > 0) {
		sLegend = "<?xml version=\"1.0\" encoding=\"utf-8\"?><FLAMINGO xmlns:fmc=\"fmc\"><fmc:Legend id=\"legend\" symbolpath=\"../../../output\" listento=\"map\" shadowsymbols=\"false\" width=\"215\" right=\"right\" top=\"top\" bottom=\"bottom\" backgroundcolor=\"#FFFFFF\"><group label=\"Legenda\" open=\"true\">";
		sPlaat = gdb_legend.split(",");
		sLagen = vis.split(",");
		for (iRecord = 0; iRecord < sLagen.length; iRecord++) {
			sLaag = "<item label=\"\" canhide=\"true\" listento=\"" + laag + "." + sLagen[iRecord] + "\"><symbol label=\"\" url=\"" + sPlaat[iRecord] + "\"/></item>";
