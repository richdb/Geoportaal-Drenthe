...
function flamingo_onInit() {
	...
	if (vis.length > 0) {
     ...
     app.call("flamingo" , "setArgument", "printMap1_" + laag, "visible" , vis);
     app.call("flamingo" , "setArgument", "printMap3_" + laag, "visible" , vis);
	  //var bool = "true";
	  //app.call("flamingo" , "callMethod", "map_" + laag, "setVisible(true, " + vis + ")");
		//alert ("hallo");
		//var test = app.call("flamingo" , "callMethod", "map_" + laag, "getVisible(" + vis + ")");
		//alert (test);
		//alert("hallo1");
	//app.call("flamingo" , "callMethod", "map_" + laag, "setVisible" , (true,vis));
   }
