...
function flamingo_onInit() {
   ...
   if (gegevens.length > 0) {
		 var ext = app.call("map", "getCurrentExtent");
		 var isvis = app.call("map_gbitest", "getVisible" );
   //return ext.minx + "," + ext.miny + "," + ext.maxx + "," + ext.maxy;
		//var app1 = document.getElementById("flamingo");
		//var visible = app1.call("map_gbitest", "getVisible"); 
			
		alert("hallo2");
		alert(ext.miny);	
		alert(isvis);
		alert("hallo2");		
			//app.call("map_" + laag, "setLayerProperty", gegevens, "identify", true);
