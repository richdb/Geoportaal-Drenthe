...
function moveSelectedOptions(from,to) {
	...
	if (!hasOptions(document.forms[0]['list2'])) { return; }
	temp = '';
	document.forms[0]['kaart'].value = "";
	for (var i=0; i<document.forms[0]['list2'].options.length; i++) {
		var o = document.forms[0]['list2'].options[i];
		if (i == 0) {
			document.forms[0]['kaart'].value = document.forms[0]['kaart'].value + o.value 
		}
		else {
			document.forms[0]['kaart'].value = document.forms[0]['kaart'].value + "|" + o.value;
		}
